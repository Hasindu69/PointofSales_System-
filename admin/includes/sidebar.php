                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link <?= ($page == 'categories-create.php') || ($page == 'categories.php') ? 'collapse active':'collapse'; ?>" 
                                href="#" 
                            ...
                            <a class="nav-link <?= ($page == 'products-create.php') || ($page == 'products.php') ? 'show':''; ?>" href="#" 
                                data-bs-toggle="collapse" 
                            ...
                            <a class="nav-link <?= ($page == 'customers-create.php') || ($page == 'customers.php') ? 'show':''; ?>" href="#" 
                            data-bs-toggle="collapse" 
                            ...
                            <a class="nav-link <?= ($page == 'admins-create.php') || ($page == 'admins.php') ? 'show':''; ?>" href="#" 
                            data-bs-toggle="collapse" 
                            ...
                            <div class="collapse <?= ($page == 'admins-create.php') || ($page == 'admin.php') ? 'show':''; ?>" id="collapseAdmins" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
